...
class TweetShow extends Component
{
    ...
    public function showStatisticInformMessage()
    {
        ...
        echo "-------------------------------------------------------------------------------------------------------------------\n";
        echo "\n\033[01;36mДопускается не полной представление даты и времени при соблюдение нисходящей последовательности (нельзя ввести только часы!)\n";
        ...
        echo "\n\033[01;36mДопускаетима замена разделителей в рекоммендованной нотации '-' на '/'\n";
